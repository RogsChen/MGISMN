...
import time
import os
from myutils.dataprocess import load_data, normalize, traintwo_patch, split_train_test_labels, padpatch, loadtrandte_data
from model.MGISMN import    MGISMN
from myutils.evulate import calculate_metrics,evaluatetwo
from myutils.output import save_metrics_and_accuracies
import random
import gc
def clear_memory():
    """清理内存函数"""
...
# -------------------------------------------------------------------------------
# Configuration Parameters H-13 M-11  T-13
...
if __name__ == "__main__":
    try:
        ...
        model = MGISMN(band1, band2, args.num_classes).to(device)

        # Data preparation - 在数据加载前后清理内存
        clear_memory()
